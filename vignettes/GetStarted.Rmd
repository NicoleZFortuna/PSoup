...
load(paste0(folder, "/exogenousScreen.RData"))
exoScreen
```
...
```{r}
modifierPriorScreen(folder, n = 5, returnVals = T)
...
To set up a series of simulations, this can be done easily by using the `setupSims` function.
