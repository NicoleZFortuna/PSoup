...
This function is what will be doing most of the work when running simulations of the network. This function is what calculates the node values at each step. It contains a series of difference equations (a discrete version of a differential equation) which are the mathematical description of the information contained in the diagram.
...
write.csv(genotypeDef, row.names = F, file = paste0(folder, "/genotypeDef.csv"))
```
