...
To see general parameters that have been applied to all siimulations, you can inspect the parameters. This will tell you how much delay was applied if you used one, and what the maxStep value was.
...
```{r}
# inspecting the first simulation object
output$screen[[1]]
```
